                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <Select value={formData.article} onValueChange={(value) => handleInputChange('article', value)}>
                                <SelectTrigger>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                placeholder="e.g., Home, Food, Travel"
                                required
                            />
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mb-2">
                                <Input
                                    ...
                                    onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addToArray('clues', newClue, setNewClue))}
                                />
                                <Button 
                                    type="button" 
                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mb-2">
                                <Input
                                    ...
                                    onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addToArray('synonyms', newSynonym, setNewSynonym))}
                                />
                                <Button 
                                    type="button" 
                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mb-2">
                                <Input
                                    ...
                                    onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), addToArray('furtherCharacteristics', newCharacteristic, setNewCharacteristic))}
                                />
                                <Button 
                                    type="button" 
                                    onClick={() => addToArray('furtherCharacteristics', newCharacteristic, setNewCharacteristic)}
                                    size="sm"
                                >
                                    <Plus className="w-4 h-4" />
                                </Button>
