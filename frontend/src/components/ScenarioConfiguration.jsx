...
const ScenarioConfiguration = () => {
  ...
  const updateConfig = async (scenarioId, level, gameTypeId) => {
    try {
        ...
        if (res.data.success) {
          ...
          setConfigs(prev => prev.map(config => 
            config._id === existingConfig._id 
              ? { ...config, gameType: gameTypes.find(gt => gt._id === gameTypeId) }
              : config
          ));
        }
      } else {
                      ...
                      <div key={level} className="border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            onChange={(e) => updateConfig(scenario._id, level, e.target.value)}
